...
def get_moving_average(ticker: str, interval: int=50):
	...
	Parameters:
		...
		interval (int): Rolling window size
	Returns:
		pd.DataFrame: DataFrame containing the close price and the calculated simple moving average
	Raises:
		Exception: if no data can be found
	"""
